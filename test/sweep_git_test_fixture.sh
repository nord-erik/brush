...
setup_file_tree() {
  temporary_git_paths[no_git_repo]=$(__create_temporary_dir)
  temporary_git_paths[a_git_repo]=$(__create_temporary_dir)
  temporary_git_paths[a_git_repo_dirty]=$(__create_temporary_dir)
  temporary_git_paths[a_git_repo_with_branches]=$(__create_temporary_dir)
  # temporary_git_paths[a_git_repo_with_merge_confict]=$(__create_temporary_dir)
  # temporary_git_paths[a_git_repo_with_rebase_flow]=$(__create_temporary_dir)
